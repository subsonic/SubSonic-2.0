...
namespace NorthwindRepository{
    ...
    public partial class OrdersQry : ReadOnlyRecord<OrdersQry>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("Orders Qry", TableType.View, DataService.GetInstance("NorthwindRepository"));
                ...
                DataService.Providers["NorthwindRepository"].AddSchema("Orders Qry",schema);
            }
        }
        #endregion
        ...
        public float? Freight 
	    {
		    get
		    {
			    return GetColumnValue<float?>("Freight");
		    }
            set 
		    {
