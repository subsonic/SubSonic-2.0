...
namespace NorthwindRepository{
    ...
    public partial class CurrentProductList : ReadOnlyRecord<CurrentProductList>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("Current Product List", TableType.View, DataService.GetInstance("NorthwindRepository"));
                ...
                DataService.Providers["NorthwindRepository"].AddSchema("Current Product List",schema);
            }
        }
        #endregion
