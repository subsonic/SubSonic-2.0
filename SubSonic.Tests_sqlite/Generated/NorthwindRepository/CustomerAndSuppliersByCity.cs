...
namespace NorthwindRepository{
    ...
    public partial class CustomerAndSuppliersByCity : ReadOnlyRecord<CustomerAndSuppliersByCity>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("Customer and Suppliers by City", TableType.View, DataService.GetInstance("NorthwindRepository"));
                ...
                colvarRelationship.MaxLength = 2147483647;
                ...
                DataService.Providers["NorthwindRepository"].AddSchema("Customer and Suppliers by City",schema);
            }
        }
        #endregion
