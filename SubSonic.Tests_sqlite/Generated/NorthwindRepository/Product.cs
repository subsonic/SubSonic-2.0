...
namespace NorthwindRepository
{
	...
	public partial class Product : RepositoryRecord<Product>, IRecordBase
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Products", TableType.Table, DataService.GetInstance("NorthwindRepository"));
				...
				DataService.Providers["NorthwindRepository"].AddSchema("Products",schema);
			}
		}
		#endregion
