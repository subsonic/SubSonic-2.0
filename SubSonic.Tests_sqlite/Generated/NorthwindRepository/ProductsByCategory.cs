...
namespace NorthwindRepository{
    ...
    public partial class ProductsByCategory : ReadOnlyRecord<ProductsByCategory>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("Products by Category", TableType.View, DataService.GetInstance("NorthwindRepository"));
                ...
                DataService.Providers["NorthwindRepository"].AddSchema("Products by Category",schema);
            }
        }
        #endregion
