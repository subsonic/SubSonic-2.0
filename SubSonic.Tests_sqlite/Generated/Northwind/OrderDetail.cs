...
namespace Northwind
{
	...
	public partial class OrderDetail : ActiveRecord<OrderDetail>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(int varOrderID,int varProductID,float varUnitPrice,short varQuantity,float varDiscount)
		{
		...
		/// </summary>
		public static void Update(int varOrderID,int varProductID,float varUnitPrice,short varQuantity,float varDiscount)
		{
			OrderDetail item = new OrderDetail();
