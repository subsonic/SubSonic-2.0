...
namespace Northwind
{
    ...
    public partial class OrderDetailController
    {
	    ...
	    public void Insert(int OrderID,int ProductID,float UnitPrice,short Quantity,float Discount)
	    {
	    ...
	    public void Update(int OrderID,int ProductID,float UnitPrice,short Quantity,float Discount)
	    {
		    OrderDetail item = new OrderDetail();
	        item.MarkOld();
	        item.IsLoaded = true;
