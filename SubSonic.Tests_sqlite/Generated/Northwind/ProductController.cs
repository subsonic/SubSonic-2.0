...
namespace Northwind
{
    ...
    public partial class ProductController
    {
	    ...
	    public void Insert(string ProductName,int? SupplierID,int? CategoryID,string QuantityPerUnit,float? UnitPrice,short? UnitsInStock,short? UnitsOnOrder,short? ReorderLevel,bool Discontinued,string AttributeXML,DateTime? DateCreated,Guid? ProductGUID,DateTime CreatedOn,string CreatedBy,DateTime ModifiedOn,string ModifiedBy,bool Deleted)
	    {
	    ...
	    public void Update(int ProductID,string ProductName,int? SupplierID,int? CategoryID,string QuantityPerUnit,float? UnitPrice,short? UnitsInStock,short? UnitsOnOrder,short? ReorderLevel,bool Discontinued,string AttributeXML,DateTime? DateCreated,Guid? ProductGUID,DateTime CreatedOn,string CreatedBy,DateTime ModifiedOn,string ModifiedBy,bool Deleted)
	    {
		    Product item = new Product();
	        item.MarkOld();
	        item.IsLoaded = true;
