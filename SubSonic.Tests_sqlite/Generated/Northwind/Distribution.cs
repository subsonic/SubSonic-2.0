...
namespace Northwind
{
	...
	/// </summary>
    [Serializable]
	public partial class DistributionCollection : ActiveList<Distribution, DistributionCollection>
	{	   
	...
	/// </summary>
	[Serializable]
	public partial class Distribution : ActiveRecord<Distribution>, IActiveRecord
	{
		...
		public Distribution(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public Distribution(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Distribution", TableType.Table, DataService.GetInstance("Northwind"));
				...
				DataService.Providers["Northwind"].AddSchema("Distribution",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(string varName,int? varCapacity)
		{
		...
		/// </summary>
		public static void Update(int varId,string varName,int? varCapacity)
		{
			Distribution item = new Distribution();
