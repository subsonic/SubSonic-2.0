    ...
    public class AggregateTests
    {
        ...
        public void Exec_AggregateStandardDeviation()
        {
            ...
            double result = new
                ...
                .ExecuteScalar<double>();
            //Assert.AreEqual(expected, result);
            Assert.IsTrue(Math.Round(expected, 8) == Math.Round(result, 8), "#1 {0} {1}", expected, result);
            ...
            result = new
                ...
                .ExecuteScalar<double>();
            //Assert.AreEqual(expected, result);
            Assert.IsTrue(Math.Round(expected, 8) == Math.Round(result, 8), "#2 {0} {1}", expected, result);
            ...
            result = new
                ...
                .ExecuteScalar<double>();
            //Assert.AreEqual(expected, result);
            Assert.IsTrue(Math.Round(expected, 8) == Math.Round(result, 8), "#3 {0} {1}", expected, result);
            ...
            result = new
                ...
                .ExecuteScalar<double>();
            //Assert.AreEqual(expected, result);
            Assert.IsTrue(Math.Round(expected, 8) == Math.Round(result, 8), "#4 {0} {1}", expected, result);
        }
