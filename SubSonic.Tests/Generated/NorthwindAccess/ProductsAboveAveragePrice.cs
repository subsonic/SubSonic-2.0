...
namespace NorthwindAccess{
    ...
    public partial class ProductsAboveAveragePrice : ReadOnlyRecord<ProductsAboveAveragePrice>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("Products Above Average Price", TableType.View, DataService.GetInstance("NorthwindAccess"));
                ...
                DataService.Providers["NorthwindAccess"].AddSchema("Products Above Average Price",schema);
            }
        }
        #endregion
