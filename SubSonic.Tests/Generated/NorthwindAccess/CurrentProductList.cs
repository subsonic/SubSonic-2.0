...
namespace NorthwindAccess{
    ...
    public partial class CurrentProductList : ReadOnlyRecord<CurrentProductList>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("Current Product List", TableType.View, DataService.GetInstance("NorthwindAccess"));
                ...
                DataService.Providers["NorthwindAccess"].AddSchema("Current Product List",schema);
            }
        }
        #endregion
