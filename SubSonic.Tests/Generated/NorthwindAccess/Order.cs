...
namespace NorthwindAccess
{
	...
	public partial class Order : ActiveRecord<Order>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Orders", TableType.Table, DataService.GetInstance("NorthwindAccess"));
				...
				DataService.Providers["NorthwindAccess"].AddSchema("Orders",schema);
			}
		}
		#endregion
		...
		{
			return new NorthwindAccess.OrderDetailCollection().Where(OrderDetail.Columns.OrderID, OrderID).Load();
		}
		#endregion
		...
		/// 
		/// </summary>
		public NorthwindAccess.Employee Employee
		{
			get { return NorthwindAccess.Employee.FetchByID(this.EmployeeID); }
		...
		/// 
		/// </summary>
		public NorthwindAccess.Shipper Shipper
		{
			get { return NorthwindAccess.Shipper.FetchByID(this.ShipVia); }
		...
		public NorthwindAccess.ProductCollection GetProductCollection() { return Order.GetProductCollection(this.OrderID); }
		public static NorthwindAccess.ProductCollection GetProductCollection(int varOrderID)
		{
		    SubSonic.QueryCommand cmd = new SubSonic.QueryCommand("SELECT * FROM [Products] INNER JOIN [Order Details] ON [Products].[ProductID] = [Order Details].[ProductID] WHERE [Order Details].[OrderID] = PARM__OrderID", Order.Schema.Provider.Name);
			cmd.AddParameter("PARM__OrderID", varOrderID, DbType.Int32);
		...
		public static void SaveProductMap(int varOrderID, ProductCollection items)
		{
			...
			QueryCommand cmdDel = new QueryCommand("DELETE FROM [Order Details] WHERE [Order Details].[OrderID] = PARM__OrderID", Order.Schema.Provider.Name);
			cmdDel.AddParameter("PARM__OrderID", varOrderID, DbType.Int32);
			coll.Add(cmdDel);
