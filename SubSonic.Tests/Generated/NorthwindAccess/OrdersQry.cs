...
namespace NorthwindAccess{
    ...
    public partial class OrdersQry : ReadOnlyRecord<OrdersQry>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("Orders Qry", TableType.View, DataService.GetInstance("NorthwindAccess"));
                ...
                DataService.Providers["NorthwindAccess"].AddSchema("Orders Qry",schema);
            }
        }
        #endregion
