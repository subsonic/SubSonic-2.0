...
namespace NorthwindAccess
{
	...
	public partial class Shipper : ActiveRecord<Shipper>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Shippers", TableType.Table, DataService.GetInstance("NorthwindAccess"));
				...
				DataService.Providers["NorthwindAccess"].AddSchema("Shippers",schema);
			}
		}
		#endregion
		...
		{
			return new NorthwindAccess.OrderCollection().Where(Order.Columns.ShipVia, ShipperID).Load();
		}
		#endregion
