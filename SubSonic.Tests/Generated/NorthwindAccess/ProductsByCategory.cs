...
namespace NorthwindAccess{
    ...
    public partial class ProductsByCategory : ReadOnlyRecord<ProductsByCategory>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("Products by Category", TableType.View, DataService.GetInstance("NorthwindAccess"));
                ...
                DataService.Providers["NorthwindAccess"].AddSchema("Products by Category",schema);
            }
        }
        #endregion
