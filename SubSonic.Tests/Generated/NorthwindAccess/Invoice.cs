...
namespace NorthwindAccess{
    ...
    public partial class Invoice : ReadOnlyRecord<Invoice>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("Invoices", TableType.View, DataService.GetInstance("NorthwindAccess"));
                ...
                TableSchema.TableColumn colvarCustomersCompanyName = new TableSchema.TableColumn(schema);
                colvarCustomersCompanyName.ColumnName = "Customers.CompanyName";
                colvarCustomersCompanyName.DataType = DbType.String;
                colvarCustomersCompanyName.MaxLength = 40;
                colvarCustomersCompanyName.AutoIncrement = false;
                colvarCustomersCompanyName.IsNullable = true;
                colvarCustomersCompanyName.IsPrimaryKey = false;
                colvarCustomersCompanyName.IsForeignKey = false;
                colvarCustomersCompanyName.IsReadOnly = false;
                
                schema.Columns.Add(colvarCustomersCompanyName);
                ...
                colvarSalesperson.MaxLength = 255;
                ...
                TableSchema.TableColumn colvarShippersCompanyName = new TableSchema.TableColumn(schema);
                colvarShippersCompanyName.ColumnName = "Shippers.CompanyName";
                colvarShippersCompanyName.DataType = DbType.String;
                colvarShippersCompanyName.MaxLength = 40;
                colvarShippersCompanyName.AutoIncrement = false;
                colvarShippersCompanyName.IsNullable = true;
                colvarShippersCompanyName.IsPrimaryKey = false;
                colvarShippersCompanyName.IsForeignKey = false;
                colvarShippersCompanyName.IsReadOnly = false;
                
                schema.Columns.Add(colvarShippersCompanyName);
                ...
                DataService.Providers["NorthwindAccess"].AddSchema("Invoices",schema);
            }
        }
        #endregion
        ...
        [XmlAttribute("CustomersCompanyName")]
        [Bindable(true)]
        public string CustomersCompanyName 
	    {
		    get
		    {
			    return GetColumnValue<string>("Customers.CompanyName");
		    }
            set 
		    {
			    SetColumnValue("Customers.CompanyName", value);
            }
        }
        ...
        [XmlAttribute("ShippersCompanyName")]
        [Bindable(true)]
        public string ShippersCompanyName 
	    {
		    get
		    {
			    return GetColumnValue<string>("Shippers.CompanyName");
		    }
            set 
		    {
			    SetColumnValue("Shippers.CompanyName", value);
            }
        }
	    ...
	    public struct Columns
	    {
            ...
            public static string CustomersCompanyName = @"Customers.CompanyName";
            ...
            public static string ShippersCompanyName = @"Shippers.CompanyName";
