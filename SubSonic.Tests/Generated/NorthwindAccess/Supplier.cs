...
namespace NorthwindAccess
{
	...
	public partial class Supplier : ActiveRecord<Supplier>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Suppliers", TableType.Table, DataService.GetInstance("NorthwindAccess"));
				...
				DataService.Providers["NorthwindAccess"].AddSchema("Suppliers",schema);
			}
		}
		#endregion
		...
		{
			return new NorthwindAccess.ProductCollection().Where(Product.Columns.SupplierID, SupplierID).Load();
		}
		#endregion
