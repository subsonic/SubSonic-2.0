...
namespace NorthwindAccess{
    ...
    public partial class SalesByCategory : ReadOnlyRecord<SalesByCategory>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("Sales by Category", TableType.View, DataService.GetInstance("NorthwindAccess"));
                ...
                DataService.Providers["NorthwindAccess"].AddSchema("Sales by Category",schema);
            }
        }
        #endregion
