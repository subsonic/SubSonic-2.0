...
namespace NorthwindAccess
{
	...
	public partial class Customer : ActiveRecord<Customer>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Customers", TableType.Table, DataService.GetInstance("NorthwindAccess"));
				...
				DataService.Providers["NorthwindAccess"].AddSchema("Customers",schema);
			}
		}
		#endregion
		...
		{
			return new NorthwindAccess.CustomerCustomerDemoCollection().Where(CustomerCustomerDemo.Columns.CustomerID, CustomerID).Load();
		}
		public NorthwindAccess.OrderCollection Orders()
		{
			return new NorthwindAccess.OrderCollection().Where(Order.Columns.CustomerID, CustomerID).Load();
		}
		#endregion
		...
		public NorthwindAccess.CustomerDemographicCollection GetCustomerDemographicCollection() { return Customer.GetCustomerDemographicCollection(this.CustomerID); }
