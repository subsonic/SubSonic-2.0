...
namespace NorthwindAccess{
    ...
    public partial class QuarterlyOrder : ReadOnlyRecord<QuarterlyOrder>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("Quarterly Orders", TableType.View, DataService.GetInstance("NorthwindAccess"));
                ...
                DataService.Providers["NorthwindAccess"].AddSchema("Quarterly Orders",schema);
            }
        }
        #endregion
