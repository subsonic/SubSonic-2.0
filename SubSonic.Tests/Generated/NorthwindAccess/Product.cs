...
namespace NorthwindAccess
{
	...
	public partial class Product : ActiveRecord<Product>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Products", TableType.Table, DataService.GetInstance("NorthwindAccess"));
				...
				colvarDiscontinued.IsReadOnly = false;
						...
						colvarDiscontinued.DefaultSetting = @"=No";
				...
				colvarDateCreated.IsReadOnly = false;
						...
						colvarDateCreated.DefaultSetting = @"Date()";
				...
				colvarCreatedOn.IsReadOnly = false;
						...
						colvarCreatedOn.DefaultSetting = @"Date()";
				...
				colvarModifiedOn.IsReadOnly = false;
						...
						colvarModifiedOn.DefaultSetting = @"Date()";
				...
				colvarDeleted.IsReadOnly = false;
						...
						colvarDeleted.DefaultSetting = @"False";
				...
				DataService.Providers["NorthwindAccess"].AddSchema("Products",schema);
			}
		}
		#endregion
		...
		public NorthwindAccess.OrderDetailCollection OrderDetails()
		{
			return new NorthwindAccess.OrderDetailCollection().Where(OrderDetail.Columns.ProductID, ProductID).Load();
		}
		public NorthwindAccess.ProductCategoryMapCollection ProductCategoryMapRecords()
		{
			return new NorthwindAccess.ProductCategoryMapCollection().Where(ProductCategoryMap.Columns.ProductID, ProductID).Load();
		}
		#endregion
		...
		/// 
		/// </summary>
		public NorthwindAccess.Supplier Supplier
		{
			get { return NorthwindAccess.Supplier.FetchByID(this.SupplierID); }
		...
		public NorthwindAccess.OrderCollection GetOrderCollection() { return Product.GetOrderCollection(this.ProductID); }
		...
		public NorthwindAccess.CategoryCollection GetCategoryCollection() { return Product.GetCategoryCollection(this.ProductID); }
		public static NorthwindAccess.CategoryCollection GetCategoryCollection(int varProductID)
		{
		    SubSonic.QueryCommand cmd = new SubSonic.QueryCommand("SELECT * FROM [Categories] INNER JOIN [Product_Category_Map] ON [Categories].[CategoryID] = [Product_Category_Map].[CategoryID] WHERE [Product_Category_Map].[ProductID] = PARM__ProductID", Product.Schema.Provider.Name);
			cmd.AddParameter("PARM__ProductID", varProductID, DbType.Int32);
			IDataReader rdr = SubSonic.DataService.GetReader(cmd);
		...
		public static void SaveCategoryMap(int varProductID, CategoryCollection items)
		{
			QueryCommandCollection coll = new SubSonic.QueryCommandCollection();
			//delete out the existing
			QueryCommand cmdDel = new QueryCommand("DELETE FROM [Product_Category_Map] WHERE [Product_Category_Map].[ProductID] = PARM__ProductID", Product.Schema.Provider.Name);
			cmdDel.AddParameter("PARM__ProductID", varProductID, DbType.Int32);
			coll.Add(cmdDel);
			DataService.ExecuteTransaction(coll);
