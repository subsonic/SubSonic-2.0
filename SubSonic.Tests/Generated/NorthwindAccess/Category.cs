...
namespace NorthwindAccess
{
	...
	public partial class Category : ActiveRecord<Category>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Categories", TableType.Table, DataService.GetInstance("NorthwindAccess"));
				...
				DataService.Providers["NorthwindAccess"].AddSchema("Categories",schema);
			}
		}
		#endregion
		...
		{
			return new NorthwindAccess.ProductCategoryMapCollection().Where(ProductCategoryMap.Columns.CategoryID, CategoryID).Load();
		}
		public NorthwindAccess.ProductCollection Products()
		{
			return new NorthwindAccess.ProductCollection().Where(Product.Columns.CategoryID, CategoryID).Load();
		}
		#endregion
		...
		public NorthwindAccess.ProductCollection GetProductCollection() { return Category.GetProductCollection(this.CategoryID); }
		...
		public static void SaveProductMap(int varCategoryID, ProductCollection items)
		{
			...
			QueryCommand cmdDel = new QueryCommand("DELETE FROM [Product_Category_Map] WHERE [Product_Category_Map].[CategoryID] = PARM__CategoryID", Category.Schema.Provider.Name);
			cmdDel.AddParameter("PARM__CategoryID", varCategoryID, DbType.Int32);
			coll.Add(cmdDel);
