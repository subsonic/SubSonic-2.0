...
namespace NorthwindAccess
{
	...
	public partial class EmployeeTerritory : ActiveRecord<EmployeeTerritory>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("EmployeeTerritories", TableType.Table, DataService.GetInstance("NorthwindAccess"));
				...
				DataService.Providers["NorthwindAccess"].AddSchema("EmployeeTerritories",schema);
			}
		}
		#endregion
		...
		/// 
		/// </summary>
		public NorthwindAccess.Territory Territory
		{
			get { return NorthwindAccess.Territory.FetchByID(this.TerritoryID); }
