...
namespace NorthwindRepository{
    ...
    public partial class Invoice : ReadOnlyRecord<Invoice>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("Invoices", TableType.View, DataService.GetInstance("NorthwindRepository"));
                ...
                DataService.Providers["NorthwindRepository"].AddSchema("Invoices",schema);
            }
        }
        #endregion
