...
namespace NorthwindRepository{
    ...
    public partial class OrderDetailsExtended : ReadOnlyRecord<OrderDetailsExtended>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("Order Details Extended", TableType.View, DataService.GetInstance("NorthwindRepository"));
                ...
                DataService.Providers["NorthwindRepository"].AddSchema("Order Details Extended",schema);
            }
        }
        #endregion
