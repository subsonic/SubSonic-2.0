...
namespace Southwind
{
	...
	public partial class Region : ActiveRecord<Region>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("region", TableType.Table, DataService.GetInstance("Southwind"));
				...
				DataService.Providers["Southwind"].AddSchema("region",schema);
			}
		}
		#endregion
