...
namespace Southwind{
    ...
    public partial class ProductsByCategory : ReadOnlyRecord<ProductsByCategory>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("products by category", TableType.View, DataService.GetInstance("Southwind"));
                ...
                DataService.Providers["Southwind"].AddSchema("products by category",schema);
            }
        }
        #endregion
