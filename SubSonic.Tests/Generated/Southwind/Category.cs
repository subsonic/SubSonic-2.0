...
namespace Southwind
{
	...
	public partial class Category : ActiveRecord<Category>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("categories", TableType.Table, DataService.GetInstance("Southwind"));
				...
				DataService.Providers["Southwind"].AddSchema("categories",schema);
			}
		}
		#endregion
