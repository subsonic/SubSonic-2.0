...
namespace Southwind{
    ...
    public partial class SalesTotalsByAmount : ReadOnlyRecord<SalesTotalsByAmount>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("sales totals by amount", TableType.View, DataService.GetInstance("Southwind"));
                ...
                DataService.Providers["Southwind"].AddSchema("sales totals by amount",schema);
            }
        }
        #endregion
