...
namespace Southwind{
    ...
    public partial class ProductsAboveAveragePrice : ReadOnlyRecord<ProductsAboveAveragePrice>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("products above average price", TableType.View, DataService.GetInstance("Southwind"));
                ...
                DataService.Providers["Southwind"].AddSchema("products above average price",schema);
            }
        }
        #endregion
