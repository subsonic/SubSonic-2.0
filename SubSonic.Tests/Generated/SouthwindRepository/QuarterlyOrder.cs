...
namespace SouthwindRepository{
    ...
    public partial class QuarterlyOrder : ReadOnlyRecord<QuarterlyOrder>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("quarterly orders", TableType.View, DataService.GetInstance("SouthwindRepository"));
                ...
                DataService.Providers["SouthwindRepository"].AddSchema("quarterly orders",schema);
            }
        }
        #endregion
