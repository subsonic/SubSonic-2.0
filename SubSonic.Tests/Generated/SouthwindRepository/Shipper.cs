...
namespace SouthwindRepository
{
	...
	public partial class Shipper : RepositoryRecord<Shipper>, IRecordBase
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("shippers", TableType.Table, DataService.GetInstance("SouthwindRepository"));
				...
				DataService.Providers["SouthwindRepository"].AddSchema("shippers",schema);
			}
		}
		#endregion
