...
namespace SouthwindRepository{
    ...
    public partial class OrdersQry : ReadOnlyRecord<OrdersQry>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("orders qry", TableType.View, DataService.GetInstance("SouthwindRepository"));
                ...
                DataService.Providers["SouthwindRepository"].AddSchema("orders qry",schema);
            }
        }
        #endregion
