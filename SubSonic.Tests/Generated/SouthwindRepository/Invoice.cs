...
namespace SouthwindRepository{
    ...
    public partial class Invoice : ReadOnlyRecord<Invoice>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("invoices", TableType.View, DataService.GetInstance("SouthwindRepository"));
                ...
                colvarSalesperson.DataType = DbType.Decimal;
                colvarSalesperson.MaxLength = 0;
                ...
                DataService.Providers["SouthwindRepository"].AddSchema("invoices",schema);
            }
        }
        #endregion
        ...
        public decimal Salesperson 
	    {
		    get
		    {
			    return GetColumnValue<decimal>("Salesperson");
		    }
            set 
		    {
