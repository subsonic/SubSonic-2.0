...
namespace SouthwindRepository{
    ...
    public partial class CategorySalesFor1997 : ReadOnlyRecord<CategorySalesFor1997>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("category sales for 1997", TableType.View, DataService.GetInstance("SouthwindRepository"));
                ...
                colvarCategorySales.DataType = DbType.Decimal;
                ...
                DataService.Providers["SouthwindRepository"].AddSchema("category sales for 1997",schema);
            }
        }
        #endregion
