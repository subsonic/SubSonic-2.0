...
namespace SouthwindRepository
{
	...
	/// </summary>
    [Serializable]
	public partial class TesttableCollection : RepositoryList<Testtable, TesttableCollection>
	{	   
	...
	/// </summary>
	[Serializable]
	public partial class Testtable : RepositoryRecord<Testtable>, IRecordBase
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("testtable", TableType.Table, DataService.GetInstance("SouthwindRepository"));
				...
				DataService.Providers["SouthwindRepository"].AddSchema("testtable",schema);
			}
		}
		#endregion
