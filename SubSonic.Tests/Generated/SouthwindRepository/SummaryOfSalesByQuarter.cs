...
namespace SouthwindRepository{
    ...
    public partial class SummaryOfSalesByQuarter : ReadOnlyRecord<SummaryOfSalesByQuarter>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("summary of sales by quarter", TableType.View, DataService.GetInstance("SouthwindRepository"));
                ...
                DataService.Providers["SouthwindRepository"].AddSchema("summary of sales by quarter",schema);
            }
        }
        #endregion
