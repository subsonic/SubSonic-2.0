...
namespace SouthwindRepository{
    ...
    public partial class CurrentProductList : ReadOnlyRecord<CurrentProductList>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("current product list", TableType.View, DataService.GetInstance("SouthwindRepository"));
                ...
                DataService.Providers["SouthwindRepository"].AddSchema("current product list",schema);
            }
        }
        #endregion
