...
namespace SouthwindRepository
{
	...
	public partial class Supplier : RepositoryRecord<Supplier>, IRecordBase
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("suppliers", TableType.Table, DataService.GetInstance("SouthwindRepository"));
				...
				DataService.Providers["SouthwindRepository"].AddSchema("suppliers",schema);
			}
		}
		#endregion
