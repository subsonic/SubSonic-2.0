...
namespace SouthwindRepository{
    ...
    public partial class SalesByCategory : ReadOnlyRecord<SalesByCategory>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("sales by category", TableType.View, DataService.GetInstance("SouthwindRepository"));
                ...
                DataService.Providers["SouthwindRepository"].AddSchema("sales by category",schema);
            }
        }
        #endregion
