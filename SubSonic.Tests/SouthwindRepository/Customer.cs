...
namespace SouthwindRepository
{
	...
	/// </summary>
    [Serializable]
	public partial class CustomerCollection : RepositoryList<Customer, CustomerCollection>
	{	   
	...
	/// </summary>
	[Serializable]
	public partial class Customer : RepositoryRecord<Customer>, IRecordBase
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("customers", TableType.Table, DataService.GetInstance("SouthwindRepository"));
				...
				colvarCompanyName.IsForeignKey = true;
				...
				colvarRegion.IsForeignKey = true;
				...
				colvarPostalCode.IsForeignKey = true;
				...
				DataService.Providers["SouthwindRepository"].AddSchema("customers",schema);
			}
		}
		#endregion
