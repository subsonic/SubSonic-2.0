...
namespace SouthwindRepository{
    ...
    public partial class OrderDetailsExtended : ReadOnlyRecord<OrderDetailsExtended>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("order details extended", TableType.View, DataService.GetInstance("SouthwindRepository"));
                ...
                DataService.Providers["SouthwindRepository"].AddSchema("order details extended",schema);
            }
        }
        #endregion
