...
namespace SouthwindRepository{
    ...
    public partial class SummaryOfSalesByYear : ReadOnlyRecord<SummaryOfSalesByYear>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("summary of sales by year", TableType.View, DataService.GetInstance("SouthwindRepository"));
                ...
                DataService.Providers["SouthwindRepository"].AddSchema("summary of sales by year",schema);
            }
        }
        #endregion
