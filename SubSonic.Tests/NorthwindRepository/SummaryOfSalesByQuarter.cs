...
namespace NorthwindRepository{
    ...
    public partial class SummaryOfSalesByQuarter : ReadOnlyRecord<SummaryOfSalesByQuarter>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("Summary of Sales by Quarter", TableType.View, DataService.GetInstance("NorthwindRepository"));
                ...
                DataService.Providers["NorthwindRepository"].AddSchema("Summary of Sales by Quarter",schema);
            }
        }
        #endregion
