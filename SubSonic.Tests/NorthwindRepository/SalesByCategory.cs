...
namespace NorthwindRepository{
    ...
    public partial class SalesByCategory : ReadOnlyRecord<SalesByCategory>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("Sales by Category", TableType.View, DataService.GetInstance("NorthwindRepository"));
                ...
                DataService.Providers["NorthwindRepository"].AddSchema("Sales by Category",schema);
            }
        }
        #endregion
