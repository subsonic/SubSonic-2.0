...
namespace NorthwindRepository{
    ...
    public partial class SummaryOfSalesByYear : ReadOnlyRecord<SummaryOfSalesByYear>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("Summary of Sales by Year", TableType.View, DataService.GetInstance("NorthwindRepository"));
                ...
                DataService.Providers["NorthwindRepository"].AddSchema("Summary of Sales by Year",schema);
            }
        }
        #endregion
