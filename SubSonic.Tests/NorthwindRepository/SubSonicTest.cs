...
namespace NorthwindRepository
{
	...
	/// </summary>
    [Serializable]
	public partial class SubSonicTestCollection : RepositoryList<SubSonicTest, SubSonicTestCollection>
	{	   
	...
	/// </summary>
	[Serializable]
	public partial class SubSonicTest : RepositoryRecord<SubSonicTest>, IRecordBase
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("SubSonicTests", TableType.Table, DataService.GetInstance("NorthwindRepository"));
				...
				DataService.Providers["NorthwindRepository"].AddSchema("SubSonicTests",schema);
			}
		}
		#endregion
