...
namespace SubSonic.Tests.MsAccess.SqlQuery
{
    ...
    public class UpdateTests
    {
        ...
        [Test]
        public void Acc_Update_SimpleSqlCheck()
        {
            ...
            Assert.IsTrue(sql == "UPDATE [Products] SET [UnitPrice]=[PARM__up_UnitPrice]\r\n WHERE [Products].[ProductID] = [PARM__ProductID0]\r\n");
        }
        ...
        [Test]
        public void Acc_Update_SimpleTyped()
        {
