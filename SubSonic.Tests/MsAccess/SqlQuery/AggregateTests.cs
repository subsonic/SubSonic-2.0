...
namespace SubSonic.Tests.MsAccess.SqlQuery
{
    ...
    public class AggregateTests
    {
        ...
        [Test]
        public void Acc_Exec_AggregateMax()
        {
			const double expected = 263.5;
        ...
        [Test]
        public void Acc_Exec_AggregateMin()
        {
        ...
        [Test]
        public void Acc_Exec_AggregateStandardDeviation()
        {
			const double expected = 33.8151114580251;
            ...
            double result = new
                ...
                .From(Product.Schema)
                .ExecuteScalar<double>();
			Assert.AreApproximatelyEqual<double, double>(expected, result, 0.00000000001d);
        ...
        [Test]
        public void Acc_Exec_SingleAggregateWithWhere()
        {
            int records = new
        ...
        [Test]
        public void Acc_Exec_AggregateWithWhereAndHaving()
        {
            int records = new
                Select(Aggregate.GroupBy("ProductID"), Aggregate.Avg("UnitPrice"))
                .From("Order Details")
        ...
        [Test]
        public void Acc_Exec_AggregateWithWhereNotHaving()
        {
            int records = new
            Select(Aggregate.GroupBy("ProductID"), Aggregate.Avg("UnitPrice"))
            .From("Order Details")
