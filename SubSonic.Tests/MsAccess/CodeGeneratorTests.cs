...
namespace SubSonic.Tests.MsAccess
{
    ...
    public class CodeGeneratorTests
    {
        ...
        /// </summary>
        [Test]
        public void Acc_CodeGen2_RunClassTemplate()
        {
        ...
        /// </summary>
        [Test]
        public void Acc_CodeGen2_RunSPTemplate()
        {
            DataProvider provider = DataService.GetInstance("NorthwindAccess");
        ...
        /// </summary>
        [Test]
        public void Acc_CodeGen2_RunStructTemplate()
        {
            DataProvider provider = DataService.GetInstance("NorthwindAccess");
        ...
        /// </summary>
        [Test]
        public void Acc_CodeGen2_VBRunViewTemplate()
        {
            DataProvider provider = DataService.GetInstance("NorthwindAccess");
        ...
        /// </summary>
        [Test]
        public void Acc_CodeGen2_VBRunStructTemplate()
        {
            DataProvider provider = DataService.GetInstance("NorthwindAccess");
        ...
        //[Test]
        //public void Acc_CodeGen2_WBTest_Common_Language() {

        //    //TableSchema.Table tbl = DataService.GetTableSchema("Products", "NorthwindAccess");
        //    //string bits = CodeService.RunTemplate(CodeService.TemplateType.Structs,@"D:\@Projects\@OpenSource\SubSonic\SubSonic\CodeGeneration\Templates\StructsTemplate.aspx", "C:\\Bop.cs", "NorthwindAccess", "", "");
