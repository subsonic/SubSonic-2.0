...
namespace SubSonic.Tests.MsAccess
{
    ...
    public class ActiveListTests
    {
        ...
        /// </summary>
        [Test]
        public void Acc_BatchSaveUpdate()
        {
            ProductCollection c = CreateProductCollection();
            c.BatchSave();
        ...
        /// </summary>
        [Test]
        public void Acc_BatchSaveUpdateNoChanges()
        {
            ProductCollection c = CreateProductCollection();
            c.BatchSave();
		...
		/// <summary>
		/// Removes the product collection.
		/// </summary>
		/// <returns></returns>
		private static void RemoveProductCollection() {
			new Delete().From(Product.Schema).Where(Product.Columns.ProductName).Like("Unit Test Product%").Execute();
		}
