...
namespace Southwind
{
	...
	public partial class Employee : ActiveRecord<Employee>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("employees", TableType.Table, DataService.GetInstance("Southwind"));
				...
				colvarLastName.IsForeignKey = true;
