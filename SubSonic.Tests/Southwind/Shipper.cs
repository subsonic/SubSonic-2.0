...
namespace Southwind
{
	...
	public partial class Shipper : ActiveRecord<Shipper>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("shippers", TableType.Table, DataService.GetInstance("Southwind"));
				...
				DataService.Providers["Southwind"].AddSchema("shippers",schema);
			}
		}
		#endregion
