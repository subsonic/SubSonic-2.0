...
namespace Southwind
{
	...
	public partial class Supplier : ActiveRecord<Supplier>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("suppliers", TableType.Table, DataService.GetInstance("Southwind"));
				...
				DataService.Providers["Southwind"].AddSchema("suppliers",schema);
			}
		}
		#endregion
