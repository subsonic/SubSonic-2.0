...
namespace Southwind{
    ...
    public partial class QuarterlyOrder : ReadOnlyRecord<QuarterlyOrder>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("quarterly orders", TableType.View, DataService.GetInstance("Southwind"));
                ...
                DataService.Providers["Southwind"].AddSchema("quarterly orders",schema);
            }
        }
        #endregion
